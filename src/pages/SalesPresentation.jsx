...
function CircleButton({ circle, label, editMode, onLabelChange, onClick }) {
  return (
    <div className="flex flex-col items-center gap-2">
      ...
      <button
        onClick={onClick}
        className="w-40 h-40 rounded-full border-2 border-white bg-white/10 backdrop-blur-sm flex items-center justify-center shadow-lg hover:bg-white/25 hover:scale-110 transition-all duration-200 focus:outline-none"
      ...
      <span className="text-center font-semibold text-white drop-shadow-lg max-w-[7rem] leading-tight text-lg">
          {label}
        </span>
      }
    </div>);
