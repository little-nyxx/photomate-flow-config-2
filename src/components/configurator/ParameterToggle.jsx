  ...
  return (
    <div className="flex flex-col items-center gap-3">
      ...
      <button
        ...
        className="relative w-32 h-16 rounded-2xl border-2 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-primary/50"
        style={{
        ...
        <motion.div
          ...
          className="absolute top-1 w-14 h-14 rounded-xl shadow-lg flex items-center justify-center"
          style={{
            left: value === 1 ? "calc(100% - 4rem)" : "0.25rem",
